...
<template>
  <div
    ...
    <div class="col-span-3 row-span-1 flex flex-col items-start border-b border-slate-300 bg-linear-to-r from-slate-100 via-slate-200 via-20% to-slate-100 px-2 py-3 @xs:col-span-2 @lg:col-span-1 @lg:row-span-2 @lg:border-b-0">
    ...
    <div class="col-span-1 row-span-1 flex h-28 w-20 items-center justify-center self-center p-2 @xs:-order-1 @xs:row-span-2 @xs:h-auto">
      <picture>
        <source
          type="image/avif"
          :srcset="`
    ...
    <div class="col-span-2 row-span-1 my-3 mr-2 ml-0 flex flex-col items-center justify-end gap-x-3 self-end @xs:@max-lg:flex-row @lg:col-span-1 @lg:row-span-2 @lg:ml-2 @lg:self-center @2xl:flex-row">
      <div class="text-primary relative my-3 shrink-0 grow-0 self-end rounded-2xl bg-slate-200 px-3 py-2 text-lg leading-none whitespace-nowrap">
