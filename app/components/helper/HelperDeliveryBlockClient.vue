...
<template>
  <div>
    ...
    <div class="pt-4">
      <sup>*</sup>
      Расчет выполняется по данным ТК "Деловые Линии" и носит предварительный характер. Для получения полной информации пройдите по
      <NuxtLink
