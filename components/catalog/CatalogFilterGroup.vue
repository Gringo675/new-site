...
<template>
  <div class="mb-4">
    <div class="overflow-hidden rounded-lg border border-orange-300 bg-orange-200">
      ...
      >
        <div class="menu-scrollbar m-2 mr-1 flex max-h-46 overflow-auto pr-1 max-md:flex-wrap max-md:gap-2 md:flex-col">
          <label
            v-for="value in fGroup.values"
            class="flex w-fit cursor-pointer items-center gap-2 rounded-xs p-1 hover:bg-gray-100 has-checked:bg-gray-200 has-disabled:cursor-default max-md:border max-md:border-gray-300"
          >
            <input
              type="checkbox"
      ...
      >
        <div class="menu-scrollbar m-2 mr-1 flex max-h-16 flex-wrap gap-1 overflow-auto pr-1 text-sm text-indigo-700">
          <div
            v-for="item in activeValues"
            class="flex w-fit rounded-xs bg-violet-100"
          >
            <span
              class="px-1"
