  ...
  <div class="my-2">
    ...
    <transition name="transition-filter-values">
      <div v-show="showValues"
           class="bg-orange-100 max-h-[194px] -mt-2 overflow-hidden rounded-md border border-purple-200"
      >
    ...
    <transition name="transition-filter-active-values">
      ...
      >
        <div class="flex flex-wrap pt-1 min-h-[30px] bg-orange-200/70 border border-purple-200 rounded-b-md  z-10 relative
