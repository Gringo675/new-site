...
export const moveCatsDebounced = {
    ...
    go(targetIndex) {
        ...
        this.timer = setTimeout(() => {
            ...
            let targetArray = (catsG.draggableCatIndex.group === 'none' ? catsG.items : catsG.items[catsG.draggableCatIndex.group].children)
...
export const handleDragEnter = (ev) => {
    ...
    if (currentIndex.group === undefined || currentIndex.group !== catsG.draggableCatIndex.group ||
        currentIndex.item == catsG.draggableCatIndex.item) return
