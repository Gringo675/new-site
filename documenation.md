...
- поиск: категории? Облако тегов для категорий.
- Каталог меню
- категории в базе актуальны до призм. Обновить/расставить пропсы после добавления угловых мер.
...
Для элементов, которые всегда должны быть выше предыдущих (меню категорий), использовать z-20.
