...
- существующий api?
- создать сайты test.chelinstrument, old.chelinstrument
...
- прописать редиректы
- система кэширования
- robots.txt (Nuxt module)
- insert Yandex && Google scripts
- метрики, оптимизации...

## chords
- hydration mismatch on production
- логирование пользовательских действий и ошибок
- пропс Диапазон измерений &plusmn120 град.
- вставить cookies warning через toast (в компоненте TheUser)
