<script setup>
import useCats from "~/composables/state/useCats";
...
<!--        подкатегория-->
        <div v-for="child in cat.children"
             class="bg-slate-200"
        >
          <NuxtLink :to="'/catalog/' + child.alias"
                    class="flex items-center my-1"
          >
            <img :src="'https://chelinstrument.ru/components/com_jshopping/files/img_categories/' + child.image"
                 class="w-10"
            >
